...
🔢 05 numbers → 🏆 80% of jackpot
👉 Shared among winners in each tier
🧠 Winning Logic Reminder
...
💡 How it works:
1️⃣ A player mints a Windfall Lotto NFT ticket
2️⃣ That ticket can later be transferred or resold
3️⃣ If the transferred ticket becomes a winning ticket
4️⃣ The final holder claims the prize
5️⃣ The original minter receives 10% of that winning ticket claim
...
The ticket is an NFT that can be sold 📈, earning 10% of the winnings if any 🏆.
